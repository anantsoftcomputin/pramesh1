        ...
        return (
          <div className="space-y-4">
            ...
            <ExpandableSection title="Our Founding Story">
              <p>
                Founded in 2001, Pramesh has grown to become one of the Leading
                Financial Services Providers. Our wide network spans more than 5
                own branches in Gujarat and serves an esteemed clientele of
                5000+ investors.
              </p>
              <p className="mt-2">
                Presently, the company is engaged in multiple areas of Financial
                Services -- Mutual Fund, Insurance, Fixed Income Securities,
                Corporate Real Estate Agent, Various Types of Loan arrangement
                as Direct Selling Agent with reputed Banks, PMS, Corporate FDs,
                NCD, Bonds.
              </p>
            </ExpandableSection>
            <ExpandableSection title="Our Approach">
              <p>
                ...
                etc., and offer clients a comprehensive suite of Wealth Creation
                Services that match clients' financial and lifestyle
                needs/goals.
              </p>
              <p className="mt-2">
                ...
                and help others in meaningful ways - according to clients'
                unique financial and lifetime needs/goals.
              </p>
              <p className="mt-2">
                At Pramesh Wealth Pvt. Ltd., we deliver our services on a
                personalized level, in the context of a one-on-one relationship
                with an experienced financial team. The management team consists
                of professionals with in-depth financial expertise in Financial
                Investment Services.
              </p>
            </ExpandableSection>
          </div>
